...
export const perguntas = [
  ...
  {
    pergunta: "Qual destas áreas NÃO é uma área comum de atuação para Engenheiros de Sistemas?",
    opcoes: [
      "Aeroespacial",
      "Bioengenharia",
      "Marketing Digital",
  ...
  {
    pergunta: "Qual a importância da modelagem de sistemas na Engenharia de Sistemas?",
    opcoes: [
  ...
  {
    pergunta: "Qual a relação entre Engenharia de Sistemas e outras disciplinas de engenharia?",
    opcoes: [
  ...
  {
    pergunta: "Por que a comunicação é uma habilidade essencial para um Engenheiro de Sistemas?",
    opcoes: [
  ...
  {
    pergunta: "Qual a importância do trabalho em equipe na Engenharia de Sistemas?",
    opcoes: [
  ...
  {
    pergunta: "Quais são as principais ferramentas utilizadas em Engenharia de Sistemas?",
    opcoes: [
  ...
  {
    pergunta: "Como a Engenharia de Sistemas contribui para um futuro sustentável?",
    opcoes: [
